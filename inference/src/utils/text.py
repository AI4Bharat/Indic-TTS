...
class TextNormalizer:
    def __init__(self):
        ...
        self.symbols2lang2word = json.load(
            open(os.path.join(PWD, "symbols.json"), encoding="utf-8")
        )
        self.alphabet2phone = json.load(
            open(os.path.join(PWD, "alphabet2phone.json"), encoding="utf-8")
        )
